// Generated by packages/contracts/scripts/generate-contracts.mjs.
...
export const ActionRefSchema = {
  "$id": "https://jami.studio/schemas/harness/action-ref.schema.json",
  ...
  "properties": {
    ...
    "route": {
      "pattern": "^harness://actions/[a-z0-9][a-z0-9-]*$",
      "type": "string"
    },
    "schemaVersion": {
      "const": "2026-06-09"
...
export const ArtifactViewSchema = {
...
export const CapabilityManifestSchema = {
  "$id": "https://jami.studio/schemas/harness/capability-manifest.schema.json",
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "additionalProperties": false,
  "properties": {
    "capabilityClass": {
    ...
    "ownerPackage": {
      "pattern": "^@jami-studio/harness[a-z0-9-]*$",
      "type": "string"
    },
...
export const ThreatModelFixtureCatalogSchema = {
  "$id": "https://jami.studio/schemas/harness/threat-model-fixture-catalog.schema.json",
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "additionalProperties": false,
  "properties": {
    "catalogId": {
      "pattern": "^tmc_[a-z0-9][a-z0-9_-]*$",
      "type": "string"
    },
    "fixtures": {
      "items": {
...
export const harnessContractSchemas = {
  "actionRef": {
    file: "schemas/action-ref.schema.json",
    id: "https://jami.studio/schemas/harness/action-ref.schema.json",
  ...
  "primitiveManifest": {
    ...
    id: "https://jami.studio/schemas/harness/primitive-manifest.schema.json",
    schema: PrimitiveManifestSchema,
    typeName: "PrimitiveManifest"
  },
  "runEvent": {
  ...
  "threatModelFixtureCatalog": {
    file: "schemas/threat-model-fixture-catalog.schema.json",
    id: "https://jami.studio/schemas/harness/threat-model-fixture-catalog.schema.json",
