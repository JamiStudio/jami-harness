...
hosted provider adapters, Mintlify build, hosted docs, hosted workbench/control routes,
hosted OTLP/export sinks, and hosted provider/store smoke evidence. Public npm packages,
GitHub Release artifacts, provenance, and release attestations are now closed for `0.1.0`;
this source tree prepares a `0.1.1` patch for changed core/SDK/CLI inspection behavior
instead of reusing stale `0.1.0` external acceptance evidence.
...
runtime/core exit criteria only; hosted providers, hosted stores, secrets, hosted
  observability, hosted docs, hosted provider/store/control routes, and Studio UI
...
- 2026-06-09 Stream 6 release, supply-chain, hosted readiness, safe claims, and public
  ...
  is the durable claims matrix and release gate. This historical pass was not a package
  publish, SBOM artifact generator, GitHub attestation workflow, Mintlify build, hosted
  deploy, or account authorization closeout; later 2026-06-13 public execution closed
  public npm publishing/provenance and GitHub release attestation evidence for `0.1.0`.
...
- 2026-06-09 post-audit implementation pass 1 added a dependency-free local SBOM
  ...
  signed archives, package contents dry-runs, and hosted deploys remained unavailable at
  that pass. Later 2026-06-13 release work closed package contents dry-runs, npm
  provenance, and GitHub release attestations for `0.1.0`; hosted deploys remain
  unavailable.
- 2026-06-09 install-readiness pass added a generated
  ...
  hosted stores, release publishing, and attestations remained unavailable at that pass.
  Later 2026-06-13 public release work closed public npm install, release publishing, and
  attestations for `0.1.0`; hosted docs, providers, stores, observability, and control
...
- 2026-06-09 release capability manifest pass added
  ...
  workbench surfaces fail-closed unsupported. This historical pass was not a publish,
  attestation, Mintlify build, hosted deploy, hosted provider adapter, hosted store, or
  workbench; later public release work closed npm publishing, package contents dry-runs,
  and GitHub attestations for `0.1.0`.

Implementation tasks:

- [~] Add CI, lint, typecheck, unit/integration/security/doc checks.
- [~] Add SBOM and artifact attestation release flow; local SBOM dry-run/check, package
  contents dry-runs, public npm provenance, GitHub Release artifacts, and GitHub
  attestations are closed for `0.1.0`; this source tree prepares a `0.1.1` patch release
  lane for changed core/SDK/CLI inspection behavior.
...
- [x] Document the current full local source-checkout harness path and modular
  ...
  SDK/CLI inspection evidence. Public package installation is supported for published
  `@jami-studio/*@0.1.0` packages.
- [x] Add a generated release/hosted capability manifest that records supported public
  package/provenance/attestation evidence while keeping unsupported Mintlify, hosted
  docs, hosted provider, hosted store, hosted observability, and hosted workbench claims
...
- [~] Local workbench generation passes through `pnpm workbench:check` and
  ...
  remain unavailable.
- [~] SBOM/provenance release dry-run pass has local SBOM generation/check, package
  contents dry-runs, public npm provenance, GitHub Release artifact/attestation evidence,
  and a generated release capability manifest; Mintlify validation/publishing, hosted
  docs, hosted providers, hosted stores, hosted observability, and hosted workbench remain
  unavailable.
...
- [~] Developers can use the CLI and SDK from a local source checkout or the published
  public `@jami-studio/*@0.1.0` packages with generated install/readiness docs; corrected
  SDK/CLI inspection behavior is prepared for `@jami-studio/harness-core`,
  `@jami-studio/harness-sdk`, and `@jami-studio/harness-cli` at `0.1.1`.
