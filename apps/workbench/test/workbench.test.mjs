...
test("workbench model is sourced from SDK runtime evidence and generated docs manifests", async () => {
  ...
  assert.equal(model.views.capabilities.hostedRoutes.publicUrlStatus, "live_smoke_passed");
  ...
  assert.equal(model.views.capabilities.hostedRoutes.humanInterventions.some((action) => action.includes("Rerun")), true);
