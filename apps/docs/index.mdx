...
The root package is `jami-harness` at version `0.1.0`. Publishable package manifests are locally pack-ready, but public registry installation is not claimed until trusted provenance publishing is configured and executed.
